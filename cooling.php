                    ...
                    <div class="  content-area">
                        <div class="row">
                            ...
                            <p><strong>Ecofriendly will keep your home HVAC system running perfectly when you need it the most.</strong></p> 
                                ...
                                <p>A ductless mini-split system is an efficient heating and cooling solution that
                                    delivers conditioned air directly to individual rooms in your home without the need
                                    for ducts. Also known as mini-split, multi-split, heat pumps, or ductless air
                                    conditioning systems, these systems are perfect for homes without traditional
                                    ductwork, as well as for garages, workshops, and additions. They are a great option
                                    if you want to add AC in a specific room or area without modifying the existing
                                    ductwork. </p>
                                ...
                                <ul>
                                    ...
                                    <li>Residential and Commerci</li>
